 ...
 if (isset($_POST["indirizzimail"]) && ($_POST["indirizzimail"] != ""))
  {
     ...
     else
	{
	 ...
	 form_textarea("corpo","",10,80,"stile3");
	 echo "<br /><br /><a title=\"allega file\" class=semplice4 href=\"#\" onclick=\"window.open('./allegafile.php', 'Allegato','toolbar=no,menubar=no,scrollbars=yes,top=10,left=5,height=500,width=750');\">Inserisci allegato</a><br />";
	 if (isset($tblautentica) && ($tblautentica != ""))
	 {  
 ...
 else
  {
   ...
   else
   {
	 ...
	 echo "<tr><th colspan=\"$numcolonne1\">";
	 form_invia("Invia MAIL agli utenti selezionati");
	 echo "</th></tr>";
	 
	 echo "<tr><th colspan=\"$numcolonne1\">Se questa e-mail &egrave; per tutti spuntare solo questa casella&nbsp;";
