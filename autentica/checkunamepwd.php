...
$userp = mysqli_real_escape_string($con,$_POST["password"]);
	...
	*/	
	{
		...
		$stringa = "<p style=\"font-size:0.85em;\">Utente: {$utente}<br /><a style=\"color:#000000;font-weight:bold;\" title=\"Cambio password\"  href=\"cambiopwd2/index.php\">-Cambio password</a><br /><a style=\"color:#000000;font-weight:bold;\" title=\"Chiudi sessione\" href=\"#\" onclick=\"logout()\";>-Chiudi sessione</a></p>";
